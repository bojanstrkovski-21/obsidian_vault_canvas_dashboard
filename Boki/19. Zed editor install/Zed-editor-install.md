...
### [Zed fails to open windows](https://zed.dev/docs/linux#zed-fails-to-open-windows)
...
### [Clicking links isn't working](https://zed.dev/docs/linux#clicking-links-isnt-working)
